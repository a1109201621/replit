...
const OPENAI_MODELS: ModelEntry[] = [
  { id: "gpt-5.5", label: "GPT-5.5", provider: "openai", desc: "最新旗舰（代号 Spud）", context: "256K", badge: "tools" },
  { id: "gpt-5.5-pro", label: "GPT-5.5 Pro", provider: "openai", desc: "顶级推理版本", context: "256K", badge: "reasoning" },
  { id: "gpt-5.5-thinking", label: "GPT-5.5 (thinking)", provider: "openai", desc: "GPT-5.5 扩展思考", context: "256K", badge: "thinking" },
  { id: "gpt-5.2", label: "GPT-5.2", provider: "openai", desc: "上代旗舰多模态", context: "128K", badge: "tools" },
...
const ANTHROPIC_MODELS: ModelEntry[] = [
  { id: "claude-opus-4-7", label: "Claude Opus 4.7", provider: "anthropic", desc: "2026 年 4 月最新旗舰，编码与代理能力大幅提升", context: "200K", badge: "tools" },
...
const GEMINI_MODELS: ModelEntry[] = [
  { id: "gemini-3.1-pro-preview", label: "Gemini 3.1 Pro Preview", provider: "gemini", desc: "最先进推理（2026/02 发布）", context: "2M", badge: "tools" },
  ...
  { id: "gemini-3.1-flash", label: "Gemini 3.1 Flash", provider: "gemini", desc: "速度与推理平衡（GA）", context: "1M", badge: "tools" },
  { id: "gemini-3.1-flash-lite", label: "Gemini 3.1 Flash Lite", provider: "gemini", desc: "高频低延迟低成本（2026/03）", context: "1M" },
  { id: "gemini-3-flash", label: "Gemini 3 Flash", provider: "gemini", desc: "新一代默认模型（2025/12 GA）", context: "1M", badge: "tools" },
...
const OPENROUTER_MODELS: ModelEntry[] = [
  { id: "x-ai/grok-4.3", label: "Grok 4.3 Beta", provider: "openrouter", desc: "2026/04 早期访问，原生视频输入", badge: "reasoning" },
  { id: "x-ai/grok-4.20", label: "Grok 4.20 Beta 2", provider: "openrouter", desc: "xAI 当前旗舰，多代理 2M 上下文", badge: "tools" },
  { id: "x-ai/grok-4-heavy", label: "Grok 4 Heavy", provider: "openrouter", desc: "最强 Grok 4（SuperGrok Heavy）", badge: "reasoning" },
  { id: "deepseek/deepseek-v4-pro", label: "DeepSeek V4 Pro", provider: "openrouter", desc: "1.6T MoE，1M 上下文（2026/04）", badge: "thinking" },
  { id: "deepseek/deepseek-v4-flash", label: "DeepSeek V4 Flash", provider: "openrouter", desc: "284B MoE 高速版", badge: "tools" },
  { id: "anthropic/claude-opus-4.7", label: "Claude Opus 4.7 (OR)", provider: "openrouter", desc: "通过 OpenRouter 的 Claude 4.7", badge: "tools" },
  { id: "google/gemini-3.1-pro", label: "Gemini 3.1 Pro (OR)", provider: "openrouter", desc: "通过 OpenRouter 的 Gemini 3.1", badge: "tools" },
  { id: "openai/gpt-5.5", label: "GPT-5.5 (OR)", provider: "openrouter", desc: "通过 OpenRouter 的 GPT-5.5", badge: "tools" },
...
const MODEL_PRICING: Record<string, { input: number; output: number }> = {
  ...
  "gpt-5.5-pro": { input: 10, output: 60 },
  ...
  "deepseek-v4-flash": { input: 0.18, output: 0.72 },
