...
const ANTHROPIC_MODELS: ModelEntry[] = [
  { id: "claude-opus-4-7", label: "Claude Opus 4.7", provider: "anthropic", desc: "最新顶级旗舰", context: "200K", badge: "tools" },
  ...
  { id: "claude-sonnet-4-7", label: "Claude Sonnet 4.7", provider: "anthropic", desc: "最新均衡旗舰", context: "200K", badge: "tools" },
  { id: "claude-sonnet-4-7-thinking", label: "Claude Sonnet 4.7 (thinking)", provider: "anthropic", desc: "扩展思考（隐藏）", context: "200K", badge: "thinking" },
  { id: "claude-sonnet-4-7-thinking-visible", label: "Claude Sonnet 4.7 (thinking visible)", provider: "anthropic", desc: "扩展思考（可见）", context: "200K", badge: "thinking-visible" },
  { id: "claude-haiku-4-7", label: "Claude Haiku 4.7", provider: "anthropic", desc: "最新轻量快速", context: "200K", badge: "tools" },
  { id: "claude-haiku-4-7-thinking", label: "Claude Haiku 4.7 (thinking)", provider: "anthropic", desc: "扩展思考（隐藏）", context: "200K", badge: "thinking" },
  { id: "claude-haiku-4-7-thinking-visible", label: "Claude Haiku 4.7 (thinking visible)", provider: "anthropic", desc: "扩展思考（可见）", context: "200K", badge: "thinking-visible" },
...
const GEMINI_MODELS: ModelEntry[] = [
  { id: "gemini-3.2-pro", label: "Gemini 3.2 Pro", provider: "gemini", desc: "最新旗舰多模态", context: "2M", badge: "tools" },
  { id: "gemini-3.2-pro-thinking", label: "Gemini 3.2 Pro (thinking)", provider: "gemini", desc: "扩展思考（隐藏）", context: "2M", badge: "thinking" },
  { id: "gemini-3.2-pro-thinking-visible", label: "Gemini 3.2 Pro (thinking visible)", provider: "gemini", desc: "扩展思考（可见）", context: "2M", badge: "thinking-visible" },
  { id: "gemini-3.2-flash", label: "Gemini 3.2 Flash", provider: "gemini", desc: "新一代极速多模态", context: "1M", badge: "tools" },
  { id: "gemini-3.1-pro-preview", label: "Gemini 3.1 Pro Preview", provider: "gemini", desc: "旗舰多模态模型", context: "2M", badge: "tools" },
...
const OPENROUTER_MODELS: ModelEntry[] = [
  { id: "x-ai/grok-5", label: "Grok 5", provider: "openrouter", desc: "xAI 最新一代旗舰", badge: "reasoning" },
  { id: "x-ai/grok-5-fast", label: "Grok 5 Fast", provider: "openrouter", desc: "xAI 高速对话新版", badge: "tools" },
  { id: "deepseek/deepseek-v4", label: "DeepSeek V4", provider: "openrouter", desc: "DeepSeek 最新旗舰", badge: "tools" },
  { id: "deepseek/deepseek-r2", label: "DeepSeek R2", provider: "openrouter", desc: "新一代强推理模型", badge: "reasoning" },
  { id: "anthropic/claude-opus-4.7", label: "Claude Opus 4.7 (OR)", provider: "openrouter", desc: "通过 OpenRouter 的 Claude 4.7", badge: "tools" },
  { id: "google/gemini-3.2-pro", label: "Gemini 3.2 Pro (OR)", provider: "openrouter", desc: "通过 OpenRouter 的 Gemini 3.2", badge: "tools" },
  { id: "qwen/qwen3.5-max", label: "Qwen 3.5 Max", provider: "openrouter", desc: "Alibaba 最大参数旗舰", badge: "thinking" },
  { id: "moonshotai/kimi-k2", label: "Kimi K2", provider: "openrouter", desc: "月之暗面新一代长文模型", context: "2M" },
  { id: "x-ai/grok-4.20", label: "Grok 4.20", provider: "openrouter", desc: "xAI 上代旗舰推理模型", badge: "tools" },
...
const MODEL_PRICING: Record<string, { input: number; output: number }> = {
  ...
  "gemini-3.2-pro": { input: 1.5, output: 12 },
  "gemini-3.2-flash": { input: 0.2, output: 0.8 },
  "gemini-3.1-pro": { input: 1.25, output: 10 },
  "gemini-3-flash": { input: 0.15, output: 0.6 },
  "gemini-2.5-pro": { input: 1.25, output: 10 },
  "gemini-2.5-flash": { input: 0.15, output: 0.6 },
  "grok-5": { input: 4, output: 20 },
  "grok-5-fast": { input: 1, output: 5 },
  "grok-4": { input: 3, output: 15 },
  "grok-4.1": { input: 3, output: 15 },
  "grok-4.20": { input: 3, output: 15 },
  "llama-4": { input: 0.2, output: 0.8 },
  "deepseek-v4": { input: 0.35, output: 1.4 },
  "deepseek-r2": { input: 0.7, output: 2.8 },
  "deepseek-v3": { input: 0.27, output: 1.1 },
  "deepseek-r1": { input: 0.55, output: 2.19 },
  "mistral-small": { input: 0.1, output: 0.3 },
  "qwen3": { input: 0.3, output: 1.2 },
  "qwen3.5": { input: 0.3, output: 1.2 },
