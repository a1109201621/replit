...
const OPENAI_MODELS: ModelEntry[] = [
  ...
  { id: "o1", label: "o1", provider: "openai", desc: "强推理模型（第一代）", context: "200K", badge: "reasoning" },
  { id: "o1-mini", label: "o1 Mini", provider: "openai", desc: "高效推理模型", context: "128K", badge: "reasoning" },
  { id: "o1-pro", label: "o1 Pro", provider: "openai", desc: "顶级推理模型（最强 o1）", context: "200K", badge: "reasoning" },
];
...
const ANTHROPIC_MODELS: ModelEntry[] = [
  ...
  { id: "claude-3-7-sonnet", label: "Claude 3.7 Sonnet", provider: "anthropic", desc: "混合推理模型", context: "200K", badge: "tools" },
  { id: "claude-3-7-sonnet-thinking", label: "Claude 3.7 Sonnet (thinking)", provider: "anthropic", desc: "扩展思考（隐藏）", context: "200K", badge: "thinking" },
  { id: "claude-3-7-sonnet-thinking-visible", label: "Claude 3.7 Sonnet (thinking visible)", provider: "anthropic", desc: "扩展思考（可见）", context: "200K", badge: "thinking-visible" },
  { id: "claude-3-5-sonnet", label: "Claude 3.5 Sonnet", provider: "anthropic", desc: "上一代均衡旗舰", context: "200K", badge: "tools" },
  { id: "claude-3-5-haiku", label: "Claude 3.5 Haiku", provider: "anthropic", desc: "上一代轻量快速", context: "200K", badge: "tools" },
  { id: "claude-3-opus", label: "Claude 3 Opus", provider: "anthropic", desc: "Claude 3 旗舰（高智能）", context: "200K", badge: "tools" },
];
...
const GEMINI_MODELS: ModelEntry[] = [
  ...
  { id: "gemini-2.0-flash", label: "Gemini 2.0 Flash", provider: "gemini", desc: "高速多模态上一代", context: "1M", badge: "tools" },
  { id: "gemini-2.0-flash-lite", label: "Gemini 2.0 Flash Lite", provider: "gemini", desc: "超轻量低成本模型", context: "1M" },
  { id: "gemini-1.5-pro", label: "Gemini 1.5 Pro", provider: "gemini", desc: "长上下文旗舰（上一代）", context: "2M", badge: "tools" },
  { id: "gemini-1.5-flash", label: "Gemini 1.5 Flash", provider: "gemini", desc: "速度优先（上一代）", context: "1M" },
];
...
const OPENROUTER_MODELS: ModelEntry[] = [
  ...
  { id: "x-ai/grok-3", label: "Grok 3", provider: "openrouter", desc: "xAI 上一代旗舰模型", badge: "tools" },
  { id: "x-ai/grok-3-mini", label: "Grok 3 Mini", provider: "openrouter", desc: "xAI 轻量高效模型", badge: "tools" },
  { id: "perplexity/sonar-pro", label: "Sonar Pro", provider: "openrouter", desc: "Perplexity 联网推理模型", badge: "tools" },
  { id: "perplexity/sonar", label: "Sonar", provider: "openrouter", desc: "Perplexity 联网搜索模型" },
  { id: "mistralai/mistral-large-2411", label: "Mistral Large", provider: "openrouter", desc: "Mistral 旗舰大模型", badge: "tools" },
  { id: "mistralai/mistral-medium-3", label: "Mistral Medium 3", provider: "openrouter", desc: "Mistral 均衡性能模型", badge: "tools" },
  { id: "qwen/qwen3-235b-a22b", label: "Qwen3 235B", provider: "openrouter", desc: "Alibaba Qwen3 旗舰 MoE", badge: "thinking" },
  { id: "qwen/qwen3-30b-a3b", label: "Qwen3 30B", provider: "openrouter", desc: "Alibaba Qwen3 轻量 MoE" },
  { id: "microsoft/phi-4", label: "Phi-4", provider: "openrouter", desc: "Microsoft 小参数高效模型" },
  { id: "nvidia/llama-3.1-nemotron-ultra-253b-v1", label: "Nemotron Ultra 253B", provider: "openrouter", desc: "NVIDIA 超大推理模型", badge: "reasoning" },
];
...
const MODEL_PRICING: Record<string, { input: number; output: number }> = {
  ...
  "nemotron": { input: 3.1, output: 12.4 },
};
